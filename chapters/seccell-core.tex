...
\atri{Put stuff from thesis outline GDoc here}
...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{data/seccells/32ksim/mycached_full.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\linewidth]{data/seccells/network_1ktlb_sim/nfv_full.pdf}
