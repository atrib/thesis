...
\begin{table}
  ...
  \begin{tabular}{!l|?c|?c}
    \toprule
    \rowstyle{\bfseries}
    Component             & \multicolumn{2}{c}{\textbf{Configuration}}                     \\
    \rowstyle{\bfseries}
                          & Baseline                      & \seccells                      \\
    \midrule
...
\begin{table}
  ...
  \begin{tabular}{!l | ?r  ?r  ?r | ?r  ?r  ?r}
    \toprule
                 & \multicolumn{3}{c|}{\textbf{Traditional}}  & \multicolumn{3}{c}{\textbf{\seccells}}  \\
    \rowstyle{\bfseries}
...
\begin{table}
  ...
  \begin{threeparttable}
    \begin{tabular}{!l | ?r | ?r | ?r | ?l | ?l}
      \toprule
                  & \multicolumn{3}{c|}{\textbf{Round-trip Cycles}}      & \multicolumn{2}{c}{\textbf{CPU}}   \\
    \rowstyle{\bfseries}
                  & Switch         & Context Saving             & Total  & OoO\tnote{1} & Model               \\\midrule
...
\begin{table}[h]
    \begin{tabular}{!l| ?l| ?l| ?l| ?l| ?l| ?l}
      \toprule
      \rowstyle{\bfseries}
      Instruction                & \multicolumn{6}{c}{\textbf{Analogous API}} \\
      \rowstyle{\bfseries}
                                 & Linux            & MPK                            & Donky                  & CHERI                        & Enclosures           & lwC               \\
      \midrule
      \sdswitch                  &                  &                                & \Code{dcall}           & \makecell[l]{\Code{CCall}\\
                                                                                                                             \Code{CReturn}} & \Code{Prolog/Epilog} & \Code{lwSwitch}   \\ \hline
      \scprot                    &  \Code{mprotect} & \Code{mpk_mprotect}  & \Code{dk_mprotect}               & \Code{CAndPerm}              &                      &                   \\ \hline
      \scinval                   &  \Code{munmap}   & \Code{mpk_free}      & \Code{dk_munmap}                 &                              &                      &                   \\ \hline
      \screval                   &  \Code{mmap}     & \Code{mpk_mmap}      & \Code{dk_mmap}                   &                              &                      &                   \\ \hline
      \makecell[l]{\scgrant \\
                   \screcv  \\ 
                   \sctfer}      &  \Code{mmap}     &                      & \makecell[l]{\Code{dk_domain}\\
                                                                                          \Code{_assign_key}} &                              &  \Code{Transfer}     &  \Code{lwOverlay} \\ \hline
      \scexcl                    &                  &                      &                                  &                              &                      &                   \\ \bottomrule
    \end{tabular}
...
at \url{https://hexhive.epfl.ch/securecells}.
