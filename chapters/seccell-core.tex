...
\begin{figure}
  \centering
  \includegraphics[width=0.75\linewidth]{media/browser_webapp.pdf}
  \caption{Browser compartmentalization with three compartments.}
  \label{fig:browser_eg}
  \includegraphics[width=\linewidth]{media/dataflow_app.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.85\linewidth]{media/seccell_arch.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.85\linewidth]{media/sc_rpc.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{data/ccs/32ksim/mycached_full.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\linewidth]{data/ccs/network_1ktlb_sim/nfv_full.pdf}
