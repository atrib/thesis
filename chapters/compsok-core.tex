...
In this chapter, we first describe a generic compartmentalized application
...
The process abstraction was introduced to isolate different applications running 
...
%-------------------------------
% Context and introduction of ARMlock
...
% Explain how ARMlock allow compartmentalization
% Isolation part
...
% Explain how ARMlock compartmentalize a browser
...
be the only parts in the application with executable \Code{wrpkru} or
...
The \browser can also install \Code{dcall}s between the \renderer and each
...
The \renderer can use \Code{SDSwitch} to enter and exit \sandbox{}es.
...
%-------------------------------
% Context and introduction of CAPSTONE
...
% Explain how CAPSTONE allows compartmentalization
% Isolation part
...
% Communication part
Compartments can also call other compartments using a special \Code{call}
...
memory and the core's register file during an inter-compartment \Code{call}.
...
% Explain how CAPSTONE compartmentalize a browser
