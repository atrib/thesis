...
\begin{table}
      \begin{tabular}{l|l|l | l | l | l}
            ...
            MMP       & ??           &  Data + Instruction & OS-tracked        & OS-tracked  & S         \\
      ...
      \caption[A comparison of comparmentalization mechanisms (summarized)]
            ...
            TODO: Move to three part table for qualifiers like stars.
            *ERIM has some support for filtering
            +CODOMs' entry point restrictions can be weak
            @limited support for static threading.
            }
...
CODOMs identifies a compartment by its program counter, i.e. code has a
