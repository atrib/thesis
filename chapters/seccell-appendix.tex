...
\begin{table}[t]
  \begin{tabular}{| l | l | l | l |}
    ...
    PROT        & Illegal address             & \Code{\_ILL\_ADDR} (0x18)         & addr                                                                                    \\ \hline
    PROT        & Illegal permissions         & \Code{\_ILL\_PERM} (0x19)         & \makecell[l]{                                              
                                                                                      (type $\ll$ 8) | perm                                                                 \\
                                                                                      type = 
                                                                                      $
                                                                                        \begin{cases}
    ...
    PROT        & Cell description invalid    & \Code{\_INV\_CELL\_STATE} (0x1b)  & 0 if cell is invalid                                                                    \\ \hline
    TFER        & Illegal address             & \Code{\_ILL\_ADDR} (0x18)         & addr                                                                                    \\ \hline
    TFER        & Target too high             & \Code{\_INV\_SDID} (0x1a)         & SD$_{tgt}$                                                                              \\ \hline
    TFER        & Illegal permissions         & \Code{\_ILL\_PERM} (0x19)         & \makecell[l]{                                              
                                                                                      (type $\ll$ 8) | perm                                                                 \\
                                                                                      type = 
                                                                                      $
                                                                                        \begin{cases}
...
\begin{table}[t]
  ...
  \end{tabular}
  \caption[]
          {(cont.) Exception causes, \Code{scause} and \Code{stval} register values for \seccells exceptions}
  \label{tab:seccells:exceptions}
\end{table}
