...
that the fetched data is the same.
The commonplace, software interface used by the allows us to extend the 
kernel system call interface with a secure invariant.
